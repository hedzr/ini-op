...
LABEL com.hedzr.image.description="ini-op tool"
LABEL description="ini-op tool"
LABEL version="$VERSION"
LABEL org.opencontainers.image.description="ini-op tool"
LABEL org.opencontainers.image.author="hedzr <hedzr@duck.com>"
LABEL org.opencontainers.image.url="https://github.com/hedzr/ini-op"
...
WORKDIR "/app"
VOLUME ["/app", "/etc/atonal/conf.d", "/go/pkg", "/tmp"]
...
#USER $USER
ENTRYPOINT ["/var/lib/atonal/atonal"]
